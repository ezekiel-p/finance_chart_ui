...
class PatternForwardHatchBarChart2 extends StatelessWidget {
  final List<charts.Series<dynamic, String>> seriesList;
  final bool animate;

  const PatternForwardHatchBarChart2(this.seriesList,
      {super.key, this.animate = false});

  factory PatternForwardHatchBarChart2.withSampleData() {
    return PatternForwardHatchBarChart2(
      _createSampleData(),
  ...
  factory PatternForwardHatchBarChart2.withRandomData() {
    return PatternForwardHatchBarChart2(_createRandomData());
  }
  ...
  Widget build(BuildContext context) {
    return charts.BarChart(
      ...
      domainAxis: charts.OrdinalAxisSpec(
          ...
          viewport: charts.OrdinalViewport('Jan', 10)),
    );
  }
